...
class Net(nn.Module):
	...
	def __init__(self):
		...
		self.conv6_ = nn.Conv2d(64, 64, 3, stride = 1, padding=1)
		self.bn6_ = nn.BatchNorm2d(64)
	...
	def forward(self, x1, m1, p):
		...
		x1 = self.bn4(F.relu(self.conv4(x1)))
		x1 = self.bn5(F.relu(self.conv5(x1)))
		x1 = self.bn6(F.relu(self.conv6(x1)))
		x1 = self.bn6_(F.relu(self.conv6_(x1)))
